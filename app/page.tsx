...
export default async function LandingPage({ searchParams }: LandingPageProps) {
  ...
  return (
    <div>
      <LoginGateTrigger gate={gateParam} />

      {/* Hero — 한 문장 임팩트 */}
      <section className="pt-10 md:pt-16 lg:pt-20 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-[2.5rem] md:text-[3.5rem] lg:text-[4rem] font-extrabold text-[#191F28] tracking-[-0.02em] leading-[1.1]">
            수익이 확인된 강사를
            <br />
            찾아보세요
          </h1>
          <p className="mt-4 md:mt-5 text-lg md:text-xl text-[#4E5968] font-medium">
