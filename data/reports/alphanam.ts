...
export const alphanamReport: Report = {
  ...
  legal: {
    ...
    copyrightLabel: '저작권 및 사용 제한',
    copyrightText:
      '본 리포트의 모든 콘텐츠(텍스트·영상·디자인·데이터)는 Proofit 및 강사의 자산이며, 무단 복제·전재·재배포·AI 학습 활용을 금합니다. Proofit의 서면 동의 없이 본 리포트의 어떠한 내용도 인용·변경할 수 없습니다.',
  },
}
